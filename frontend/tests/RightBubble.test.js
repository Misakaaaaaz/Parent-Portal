...
import RightBubble from '../src/career/RightBubble';
...
describe('RightBubble Component', () => {
    const mockData = [
    ...
    it('renders the Bubble chart when data is provided', () => {
        render(<RightBubble data={mockData} onBubbleClick={mockOnBubbleClick} />);
        expect(screen.getByTestId('mock-bubble-chart')).toBeInTheDocument();
    });

    it('applies correct color based on isLeft prop', () => {
        const { rerender } = render(<RightBubble data={mockData} isLeft={true} onBubbleClick={mockOnBubbleClick} />);
        ...
        rerender(<RightBubble data={mockData} isLeft={false} onBubbleClick={mockOnBubbleClick} />);
    ...
    it('handles empty data array', () => {
        render(<RightBubble data={[]} onBubbleClick={mockOnBubbleClick} />);
        expect(screen.getByText('Loading...')).toBeInTheDocument();
    });
});